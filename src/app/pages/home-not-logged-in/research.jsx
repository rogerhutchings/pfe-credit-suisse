...
const HomePageResearch = (({ count, screenWidth, showDialog, volunteerCount }) =>
  <section className="home-research">
    ...
    <div className="home-research__researchers">
      <div><Thumbnail role="presentation" src="/assets/home-researchers1.jpg" width={450} /></div>

      {screenWidth > 550 && (
        <div><Thumbnail role="presentation" src="/assets/home-researchers2.jpg" width={450} /></div>
      )}

      {screenWidth > 900 && (
        <div><Thumbnail role="presentation" src="/assets/home-researchers3.jpg" width={450} /></div>
      )}
    </div>
